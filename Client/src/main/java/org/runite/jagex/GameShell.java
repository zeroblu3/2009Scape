...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    final synchronized void method30(byte var1) {
        try {
            if (Class3_Sub28_Sub12.canvas != null) {
                Class3_Sub28_Sub12.canvas.removeFocusListener(this);
                Class3_Sub28_Sub12.canvas.getParent().remove(Class3_Sub28_Sub12.canvas);
            }
            ...
            Class3_Sub28_Sub12.canvas = new ComponentWrappedCanvas(this);
            if (var1 >= 30) {
                ((Container) var2).add(Class3_Sub28_Sub12.canvas);
                Class3_Sub28_Sub12.canvas.setSize(Class23.anInt454, Class140_Sub7.anInt2934);
                Class3_Sub28_Sub12.canvas.setVisible(true);
                if (var2 == frame) {
                    Insets var3 = frame.getInsets();
                    Class3_Sub28_Sub12.canvas.setLocation(Class84.anInt1164 + var3.left, var3.top + Class106.anInt1442);
                } else {
                    Class3_Sub28_Sub12.canvas.setLocation(Class84.anInt1164, Class106.anInt1442);
                }

                Class3_Sub28_Sub12.canvas.addFocusListener(this);
                Class3_Sub28_Sub12.canvas.requestFocus();
                Class163_Sub2_Sub1.aBoolean4013 = true;
                Class3_Sub13_Sub10.aBoolean3116 = true;
        ...
        try {
            ...
            if (50 < Class3_Sub13_Sub25.anInt3313++) {
                ...
                if (frame != null && null == Class3_Sub13_Sub10.aFrame3121) {
                    ...
                    Class3_Sub28_Sub12.canvas.setLocation(var8.left + Class84.anInt1164, Class106.anInt1442 + var8.top);
                } else {
                    Class3_Sub28_Sub12.canvas.setLocation(Class84.anInt1164, Class106.anInt1442);
                }
            }
        ...
        try {
            try {
                ...
                while (Class3_Sub9.aLong2313 == 0 || Class3_Sub9.aLong2313 > TimeUtils.time()) {
                    ...
                    this.method37();
                    Class81.method1400(Class38.aClass87_665, Class3_Sub28_Sub12.canvas, -80);
                }
