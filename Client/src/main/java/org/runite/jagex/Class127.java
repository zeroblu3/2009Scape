         ...
         if(0 != Class3_Sub13_Sub25.loginStage && 5 != Class3_Sub13_Sub25.loginStage) {
            try {
               ...
               if(Class3_Sub13_Sub25.loginStage == 2) {
                  ...
                  long var1 = Class3_Sub13_Sub16.aLong3202 = WorldMapZoomFont.username.toLong();
               ...
               if(Class3_Sub13_Sub25.loginStage == 3) {
                  ...
                  Class3_Sub13_Sub1.outgoingBuffer.writeLong(WorldMapZoomFont.username.toLong());
                  Class3_Sub13_Sub1.outgoingBuffer.writeString(WorldMapZoomFont.password);
                  ...
                  Unsorted.aClass3_Sub30_Sub1_2942.writeByte(WorldMapZoomFont.anInt3671);
