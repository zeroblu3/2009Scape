...
final class Class3_Sub13_Sub12 extends Class3_Sub13 {
    ...
    static void method226(int var0) {
        try {
            ...
            throw Class44.clientError(var6, "fn.F(" + var0 + ')');
        }
    }
    ...
    static int method228(CacheIndex var0, CacheIndex var1, boolean var2) {
        try {
            int var3 = 0;
            if (var0.method2144(Sprites.p11FullSpriteArchive)) {
                ++var3;
            }

            if (var0.method2144(Sprites.p12FullSpriteArchive)) {
                ++var3;
            }

            if (var0.method2144(Sprites.b12FullSpriteArchive)) {
                ++var3;
            }

            if (var1.method2144(Sprites.p11FullSpriteArchive)) {
                ++var3;
            }


            if (var1.method2144(Sprites.p12FullSpriteArchive)) {
                ++var3;
            }

            if (var1.method2144(Sprites.b12FullSpriteArchive)) {
                ++var3;
            }
