...
class Class127 {
   ...
   static void handleLogin(byte var0) {
      try {
         if(0 != Class3_Sub13_Sub25.loginStage && 5 != Class3_Sub13_Sub25.loginStage) {
            try {
               ...
               if(Class3_Sub13_Sub25.loginStage == 2) {
                  ...
                  long var1 = Class3_Sub13_Sub16.aLong3202 = WorldMap.username.toLong();
               ...
               if(Class3_Sub13_Sub25.loginStage == 3) {
                  ...
                  Class3_Sub13_Sub1.outgoingBuffer.writeLong(WorldMap.username.toLong());
                  Class3_Sub13_Sub1.outgoingBuffer.writeString(WorldMap.password);
                  ...
                  Unsorted.aClass3_Sub30_Sub1_2942.writeByte(WorldMap.anInt3671);
         ...
         throw ClientErrorException.clientError(var8, "ri.A(" + var0 + ')');
      }
   }
