package plugin.npc.city.alkharid;
...
public class Avan extends DialoguePlugin {
    ...
    @Override
    public DialoguePlugin newInstance(Player player){return new plugin.npc.city.alkharid.Avan(player);}

    @Override
    public boolean open(Object... args){
        player("Can you transform these into Goldsmith Gauntlets for me?");
        return true;
    }
            ...
            case 3:
                if(player.getInventory().contains(995,25000) && player.getInventory().contains(778, 1)) {
                    ...
                    if(player.getInventory().freeSlots() > 0) {
                        player.getInventory().add(new Item(776));
                    } else {
