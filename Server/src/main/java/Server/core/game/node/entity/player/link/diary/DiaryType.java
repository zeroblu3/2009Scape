...
public enum DiaryType {
    ...
    FREMENNIK("Fremennik", 19,
            new String[][]{
                    ...
                    },
                    {
                            ...
                            "Watch a shouting match between Fremennik Isles tower guards<br><br>(the guards can be found between Jatizso and Neitiznot in one of the towers)",
                    ...
                    {
                            "Kill three dagannoths in the first layer of the<br><br>Waterbirth Island Dungeon",
    ...
    SEERS_VILLAGE("Seers' Village", 27,
            new String[][]{
                    {
                            "Pick 5 flax.",
                            "Walk clockwise around the Mysterious statue.",
                            "Have Sir Galahad make you a cup of tea.",
                            "Take the poison chalice to King Arthur.",
                            "Spin 5 bow strings.",
                            "Fill five pots with flour from Sinclair Mansion.",
                            "Give five locals a glass of cider in the Foresters' Arms.",
                            "Plant jute seeds.",
                            "Use the churn in Sinclair Mansion garden.",
                            "Buy a candle from the candle maker.",
                            "Pray at Seers' Village altar.",
                            "Catch a mackerel."
                    },
                    {
                            ...
                            "Use a familiar to make a fire from maple logs within Seers' Village.",
                    ...
                    },
                    {
                            ...
                            "Enter the Seers' Village courthouse with your Piety prayer turned on.",
     ...
     */
    DiaryType(String name, int child, String[][] achievements, Item[][] rewards, String info, int[] npcs) {
        this.name = name;
        this.child = child;
