...
public enum SpecialNode {
	EVIL_TURNIP(new FarmingNode(new Item(12148), new Item(12134), 4, 1, 4, 42, new double[] { 841, 46 })),
	CACTUS(new PickingNode(new Item(5280), new Item(6016), 8, 7, 80, 55, new double[] { 66.5, 25, 374 }, 3) {
		@Override
