 ...
 * @author Empathy
 */
public class TridentOfSwampHandler extends CombatSwingHandler {

	/**
	 * The Spell
	 */
	private static final CombatSpell SPELL = (CombatSpell) SpellBookManager.SpellBook.MODERN.getSpell(127);
	
	/**
	 * The instance.
	 */
	public static final TridentOfSwampHandler INSTANCE = new TridentOfSwampHandler();
