...
public final class HorvikDialogue extends DialoguePlugin {
	...
	public boolean open(Object... args) {
		npc = (NPC) args[0];
		interpreter.sendDialogues(npc, FacialExpression.HALF_GUILTY, "Hello, do you need any help?");
		stage = 0;
		return true;
	}
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 1:
			...
			switch (buttonId) {
			case 1:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "No, thanks. I'm just looking around.");
				stage = 10;
				break;
			case 2:
				end();
			...
			break;
		case 10:
			interpreter.sendDialogues(npc, FacialExpression.HALF_GUILTY, "Well, come and see me if you're ever in need of armour!");
			stage = 11;
			break;
		case 11:
			end();
