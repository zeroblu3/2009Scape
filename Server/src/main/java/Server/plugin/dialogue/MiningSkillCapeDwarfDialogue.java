	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 1:
			...
			case 2:
				...
				break;
			case 3:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Can you tell me about your skillcape?");
				stage = 40;
				break;
			case 4:
		...
		case 20:
			...
			break;
		case 21:
			interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I don't see many dwarves", "selling armour or weapons here.");
			stage = 22;
			break;
		case 22:
