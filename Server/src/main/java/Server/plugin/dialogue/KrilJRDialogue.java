...
public final class KrilJRDialogue extends DialoguePlugin {
	...
	public boolean open(Object... args) {
		npc = (NPC) args[0];
		interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "How's life in the light?");
		stage = 0;
		return true;
	}
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 0:
			...
			break;
		case 1:
			interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "You seem much nicer than your father. He's mean.");
			stage = 2;
			break;
		case 2:
			...
			break;
		case 3:
			interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I guess.");
			stage = 4;
			break;
		case 4:
			...
			break;
		case 5:
			interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Uh.... Yeah.");
			stage = 6;
			break;
		case 6:
			end();
