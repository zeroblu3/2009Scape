	...
	public boolean handle(int interfaceId, int buttonId) {
		if (stage == 0 && buttonId == 1 || player.getAttribute("thurgo:1", false)) {
			...
			case 0:
				switch (buttonId) {
				case 1:
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "That's an unusual cape you're wearing, what is it?");
					stage = 10;
			...
			case 15:
				if (player.getInventory().freeSlots() < 2) {
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Sorry, I don't have enough room in my inventory.");
					stage = 14;
					return true;
				}
		...
		case 60:
			switch (stage) {
			case 0:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "About that sword...");
				stage = 1;
				break;
			case 1:
			...
			case 2:
				if (player.getInventory().containsItem(BLURITE_ORE) && player.getInventory().containsItem(IRON_BARS)) {
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I have them right here.");
					stage = 5;
				} else {
					if (player.getInventory().containsItem(BLURITE_ORE)) {
						interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I don't have enough iron bars...");
						stage = 3;
						return true;
					}
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I don't have any blurite ore yet...");
					stage = 3;
				}
				break;
			case 3:
			...
			case 6:
				if (player.getInventory().remove(BLURITE_ORE) && player.getInventory().remove(IRON_BARS)) {
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Thank you very much!");
		...
		case 50:
			...
			case 0:
				if (player.getInventory().contains(666, 1)) {
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I have found a picture of the sword I would like you to", "make.");
					stage = 5;
				} else {
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "About that sword...");
					stage = 1;
			...
			case 1:
				...
				break;
			case 2:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Sorry, not yet.");
				stage = 3;
				break;
			case 3:
			...
			case 11:
				...
				break;
			case 12:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Ok. I'll go and find them then.");
				stage = 13;
				break;
			case 13:
		...
		case 30:
			switch (stage) {
			case 0:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Can you make me a special sword?");
				stage = 1;
				break;
			case 1:
				...
				break;
			case 2:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I need you to make a sword for one of Falador's", "knights. He had one which was passed down through five", "generations, but his squire has lost it. So we need an", "identical one to replace it.");
				stage = 3;
				break;
			case 3:
			...
			case 4:
				...
				break;
			case 5:
				interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "I'll go and ask if his squire and see if I can find one.");
				stage = 6;
				break;
			case 6:
		...
		case 20:
			...
			case 0:
				if (player.getInventory().containsItem(REDBERRY_PIE)) {
					...
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Hello. Are you an Imcando dwarf?");
					stage = 10;
				}
				break;
			case 1:
				...
				case 1:
					...
					break;
				case 2:
					interpreter.sendDialogues(player, FacialExpression.HALF_GUILTY, "Would you like some redberry pie?");
					stage = 20;
					break;
				}
				break;
