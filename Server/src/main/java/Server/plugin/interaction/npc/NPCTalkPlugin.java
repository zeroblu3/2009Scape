...
import plugin.activity.gnomecooking.GnomeCookingJob;
import plugin.activity.gnomecooking.GnomeTipper;
import plugin.dialogue.FacialExpression;

import static plugin.activity.gnomecooking.GnomeCookingConstantsKt.*;
