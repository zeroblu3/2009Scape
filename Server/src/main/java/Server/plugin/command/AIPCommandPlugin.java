...
import core.game.node.entity.player.ai.general.GeneralBotCreator;
import core.game.node.entity.player.ai.general.scriptrepository.LobsterCatcher;
import core.game.node.entity.player.ai.general.scriptrepository.ManThiever;
import core.game.node.entity.player.ai.pvmbots.PvMBotsBuilder;
import core.game.node.entity.player.ai.pvp.PVPAIPActions;
import core.game.node.entity.player.ai.pvp.PVPAIPBuilderUtils;
import core.game.node.entity.player.ai.resource.ResourceAIPActions;
import core.game.node.entity.player.ai.skillingbot.SkillingBotsBuilder;
import core.game.node.entity.player.ai.wilderness.PvPBotsBuilder;
