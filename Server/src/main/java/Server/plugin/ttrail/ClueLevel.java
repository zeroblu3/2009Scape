...
public enum ClueLevel {
	...
	HARD(new Item(2720), 1 << 16 | 8,
			new ChanceItem(13101, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(13099, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10470, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10472, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10474, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10440, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10442, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10444, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2628, 1, 1, DropFrequency.UNCOMMON),
			// Trimmed
			// rune
			// shit
			new ChanceItem(2623, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2625, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2629, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2619, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(3477, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2615, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2617, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2628, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2628, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(3476, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2621, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2673, 1, 1, DropFrequency.UNCOMMON),
			// God
			// armour
			// shit
			new ChanceItem(2669, 1, 1, DropFrequency.RARE),
			new ChanceItem(2671, 1, 1, DropFrequency.RARE),
			new ChanceItem(3480, 1, 1, DropFrequency.RARE),
			new ChanceItem(2675, 1, 1, DropFrequency.RARE),
			new ChanceItem(2657, 1, 1, DropFrequency.RARE),
			new ChanceItem(2653, 1, 1, DropFrequency.RARE),
			new ChanceItem(2655, 1, 1, DropFrequency.RARE),
			new ChanceItem(2659, 1, 1, DropFrequency.RARE),
			new ChanceItem(2665, 1, 1, DropFrequency.RARE),
			new ChanceItem(2661, 1, 1, DropFrequency.RARE),
			new ChanceItem(3478, 1, 1, DropFrequency.RARE),
			new ChanceItem(2663, 1, 1, DropFrequency.RARE),
			new ChanceItem(2667, 1, 1, DropFrequency.RARE),
			new ChanceItem(3479, 1, 1, DropFrequency.RARE),
			new ChanceItem(10286, 1, 1, DropFrequency.RARE),
			// heraldic
			// shit
			new ChanceItem(10667, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10288, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10670, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10290, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10673, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10292, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10676, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10294, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10679, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(7376, 1, 1, DropFrequency.UNCOMMON),
			// Blue
			// dragonhide
			// trimmed
			new ChanceItem(7384, 1, 1, DropFrequency.COMMON),
			new ChanceItem(7374, 1, 1, DropFrequency.COMMON),
			new ChanceItem(7382, 1, 1, DropFrequency.COMMON),
			// God
			// dhide
			new ChanceItem(10368, 1, 1, DropFrequency.RARE),
			new ChanceItem(10370, 1, 1, DropFrequency.RARE),
			new ChanceItem(10372, 1, 1, DropFrequency.RARE),
			new ChanceItem(10376, 1, 1, DropFrequency.RARE),
			new ChanceItem(10378, 1, 1, DropFrequency.RARE),
			new ChanceItem(10380, 1, 1, DropFrequency.RARE),
			new ChanceItem(10384, 1, 1, DropFrequency.RARE),
			new ChanceItem(10386, 1, 1, DropFrequency.RARE),
			new ChanceItem(10388, 1, 1, DropFrequency.RARE),
			// Hats
			new ChanceItem(2651, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2581, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(2639, 1, 1, DropFrequency.UNCOMMON),
			// Cavaliers
			new ChanceItem(2641, 1, 1, DropFrequency.COMMON),
			new ChanceItem(2643, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1163, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1127, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1079, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1093, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1201, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1185, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1213, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1275, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1289, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1303, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1319, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1359, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1373, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1432, 1, 1, DropFrequency.COMMON),
			new ChanceItem(4824, 10, 43, DropFrequency.COMMON),
			new ChanceItem(9144, 6, 23, DropFrequency.COMMON),
			new ChanceItem(9185, 1, 1, DropFrequency.COMMON),
			new ChanceItem(1747, 1, 1, DropFrequency.COMMON),
			new ChanceItem(2503, 1, 1, DropFrequency.COMMON),
			new ChanceItem(861, 1, 2, DropFrequency.COMMON),
			new ChanceItem(859, 1, 2, DropFrequency.COMMON),
			new ChanceItem(8783, 6, 27, DropFrequency.COMMON),
			new ChanceItem(380, 16, 38, DropFrequency.COMMON),
			new ChanceItem(386, 7, 32, DropFrequency.COMMON),
			new ChanceItem(10382, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10374, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(10389, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(7398, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(7399, 1, 1, DropFrequency.UNCOMMON),
			new ChanceItem(7400, 1, 1, DropFrequency.UNCOMMON)),
